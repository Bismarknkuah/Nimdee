...
export class PdfService {
  private render(build: (doc: Doc) => void): Promise<Buffer> {
    return new Promise((resolve, reject) => {
      const doc = new PDFDocument({ size: 'A4', margin: 40, info: { Producer: 'Nimdee' } });
      const chunks: Buffer[] = [];
    ...
    return this.render((doc) => {
      ...
      this.kv(
        ...
        [
          ...
          ['Recorded by', payment.recordedByName ?? 'Nimdee'],
        ],
        320,
        y,
      );
      ...
      doc
        ...
        .fontSize(8)
        .fillColor('#9ca3af')
        .text('This receipt was generated electronically by Nimdee and is valid without a signature.', 40, doc.y, {
          align: 'center',
          width: 515,
        });
    });
  ...
  reportCard(data: {
    ...
    return this.render((doc) => {
      ...
      doc
        ...
        .fillColor('#9ca3af')
        .text(
          `Generated by Nimdee on ${new Date().toLocaleDateString('en-GB')}${sheet.status !== 'PUBLISHED' ? '  •  DRAFT — NOT YET PUBLISHED' : ''}`,
          40,
          doc.page.height - 50,
  ...
  invoice(data: InvoicePdfData) {
    ...
    return this.render((doc: any) => {
      ...
      doc
        ...
        .fillColor('#9ca3af')
        .text(
          'Pay at the school office, by Mobile Money, bank transfer or online through the parent portal. Generated by Nimdee.',
          40,
          doc.page.height - 50,
          { align: 'center', width: 515 },
        );
  ...
  statement(data: any) {
    ...
    return this.render((doc: any) => {
      ...
      doc
        .fontSize(8)
        .fillColor('#9ca3af')
        .text(`Generated by Nimdee on ${new Date().toLocaleDateString('en-GB')}`, 40, doc.page.height - 50, {
          align: 'center',
          width: 515,
        });
    });
  ...
  payslip(data: { school: any; run: any; item: any }) {
    ...
    return this.render((doc: Doc) => {
      ...
      doc
        .fontSize(8)
        .fillColor('#9ca3af')
        .text('This payslip is confidential. Generated by Nimdee.', 40, doc.page.height - 50, {
          align: 'center',
          width: 515,
        });
    });
